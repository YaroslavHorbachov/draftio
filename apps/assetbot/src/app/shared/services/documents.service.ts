...
import { catchError, forkJoin, from, map, Observable, shareReplay, switchMap } from 'rxjs';
...
export class DocumentsService {
  ...
  public get rawAll$(): Observable<DocumentRowModel[][]> {
  ...
  public get flatAll$(): Observable<DocumentRowModel[]> {
    return this.rawAll$.pipe(map((all) => all.flat()));
  }
